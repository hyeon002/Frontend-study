...
// ? 숫자형 (number)
// : 정수, 실수, 10진수, 그 외의 숫자 형태를 가리지 않고 사용 가능
let num = 10;
let float = 10.5;
...
// 터미널에서는 입력한 내용을 다 기억하고 있기 때문에 방향키로 그 전의 명령을 알 수 있음
...
// : 어떤 수학적 연산이든 NaN 을 만나면 결과값이 NaN
...
// JS (JavaScript) 의 불리언 변환에서 
// : false, 0, '', null, undefined, NaN 을 제외한 데이터는 
// : 모두 true 로 간주 
